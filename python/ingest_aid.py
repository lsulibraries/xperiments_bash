#ingest_aid for moving cpd.zips and >1Gig .zips into subfolders, automatic population of 'drush-commands' with namespace, src files, and and contentmodels
...
def cpd_gig_dirmaking():
    ...
    for line in filelist:
        ...
        elif os.stat(line).st_size > 2450:
